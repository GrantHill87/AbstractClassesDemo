...
namespace ConsoleUI
{
    public class Motorcycle : Vehicle
    {
        ...
        {
            Console.WriteLine($"This {GetType().Name} is a {GetType().BaseType.Name} that is virtually in drive."); //GetType is a predefined method, found in one of the systems
            ...
            //this derived class, motorcylce, is based from.
        }
    }
}
